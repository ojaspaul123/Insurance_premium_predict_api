...
class UserInput(BaseModel):
    ...
    def age_group(self) -> str:
        # NOTE: these strings must exactly match the categories the
        # OneHotEncoder was trained on. If your model was trained with
        # a different spelling (e.g. "middle-aged" with a hyphen),
        # change the value below to match.
        if self.age < 25:
            return "young"
        elif self.age < 45:
            return "adult"
